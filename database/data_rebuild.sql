...
-- Add foreign key constraint to inventory
ALTER TABLE IF EXISTS public.inventory
    ADD CONSTRAINT fk_inv_classification 
...
-- Query 6 from Task 1: Update all inventory records to add "/vehicles" to image paths
UPDATE inventory
